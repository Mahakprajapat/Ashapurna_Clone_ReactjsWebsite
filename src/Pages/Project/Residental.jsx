...
import office from '../../image/e44d7414-b6eb-4b02-bc27-514535f22f30-1671691861.svg'
import '../../Pages/Pages.css'
import { Link } from 'react-router-dom';
import Footer from '../../Component/Footer';
import axios from 'axios';
import { residentalUrl } from '../../API/BaseUrl';

export default function Residental() {
    // let [projectimagePath,setprojectimagePath] = useState('')
    // let [getNewlaunchs,setgetNewlaunchs]= useState([])
    // let residentialData=()=>{
    //     axios.get(residentalUrl)
    //     .then((res)=>res.data)
    //     .then((finalRes)=>{
    //         let finalData =(finalRes.data)
    //         setprojectimagePath(finalData.project_image_path)
    //         setgetNewlaunchs(finalData.getNewlaunchs)
    //     })
    // }
    // useEffect(()=>{
    //     window.scrollTo(0,0)
            ...
            <div className="container-fluid mt-5">
                <div className="conatiner">
                    <div className="row text-center">
                        <h2 className="fw-bold">Residential Projects</h2>
                    </div>
                    ...
                    <div class="projects-nav py-lg-3"><ul class="list-unstyled text-center">
                        ...
                        <li class="mb-lg-3 mx-2 d-inline-block">
                            <Link class="text-decoration-none text-color d-flex align-items-center px-2 fs-15 " to={"/Rentallease"}>Rental & lease</Link>
                        </li>
                        <li class="mb-lg-3 mx-2 d-inline-block">
